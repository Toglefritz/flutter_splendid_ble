...
/// read values from the characteristic. The interface resembles a chat interface, with messages sent to the Bluetooth
/// device displayed on the right side of the interface and messages read from the device displayed on the left.
///
/// For Bluetooth characteristics that only have read properties (whether encrypted or unencrypted), the UI element used
/// to input messages to be sent to the Bluetooth characteristic is hidden. This interface is displayed for
