...
class ScanRoute extends StatefulWidget {
  ...
  /// including device names, service UUIDs, manufacturing data, vendor identifiers, and other data. This information is
  /// all specified in the firmware running on the Bluetooth devices.
  ///
  ...
  /// detecting a device and returning it in the scan list, and whether or not the same device will be returned multiple
  /// times during the scanning process.
