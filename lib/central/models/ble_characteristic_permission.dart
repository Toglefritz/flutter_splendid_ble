...
///
/// Each permission corresponds to a specific type of operation that can be performed on the characteristic, determining
/// the allowed interactions with it. These permissions are a representation of Android's `BluetoothGattCharacteristic`
/// permissions.
enum BleCharacteristicPermission {
  ...
  ///
  /// This permission ensures that the data exchanged is encrypted for security. It's a level up from the basic [read]
  /// permission.
  readEncrypted,

  /// Allows the characteristic value to be read with encryption and protection against Man-in-the-Middle (MITM)
  /// attacks.
  ///
  /// This is a higher level of security, ensuring not only encryption but also authentication, making it difficult for
  /// unauthorized devices to intercept and alter the data being exchanged.
  readEncryptedMitm,
  ...
  ///
  /// Like its read counterpart, this permission ensures that data being sent to update the characteristic value is
  /// encrypted.
  writeEncrypted,

  /// Allows the characteristic value to be written with encryption and protection against MITM attacks.
  ///
  /// This provides a secure mechanism for devices to send updates to the characteristic value, ensuring the data is
  ...
  ///
  /// This ensures that not only is the data signed for authenticity, but it is also protected against tampering and
  /// interception by unauthorized devices.
  writeSignedMitm;
...
/// access the bitmask value of each permission. Bitmask values are essential in Bluetooth communication to represent
/// permissions in a compact, bitwise format.
