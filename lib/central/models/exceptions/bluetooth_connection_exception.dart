...
///
/// This exception is thrown when an attempt to connect to a Bluetooth Low Energy (BLE) peripheral fails or encounters a
/// problem. Establishing a connection is the first step in BLE communication, which enables further interactions such
/// as service discovery, reading, and writing characteristic values.
///
/// The `BluetoothConnectionException` carries a [message] that provides more information about the failure, which can
/// be valuable for troubleshooting or informing the user about what went wrong.
///
/// ## Example
