...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to: **'Test App'**
  String get appTitle;

  /// Title for the BLE test console screen
  ///
  /// In en, this message translates to: **'BLE Test Console'**
  String get bleTestConsoleTitle;

  /// Title shown when the test console is ready but no tests have been run
  ///
  /// In en, this message translates to: **'Ready to run BLE tests'**
  String get readyToRunTestsTitle;

  /// Label for the button that starts BLE tests
  ///
  /// In en, this message translates to: **'Run Tests'**
  ...
  ///
  /// In en, this message translates to: **'Start Tests'**
  String get startTestsTooltip;

  /// Instruction text telling the user how to start tests
  ///
  /// In en, this message translates to: **'Tap \"Run Tests\" to start scanning for devices'**
